const fs = require('fs');
const BT = '`';
const dest = 'C:\\Users\\pala.TRN\\Downloads\\POC\\frontend\\src\\app\\pages\\login\\login.component.ts';
...
"                <div class=\"lp-input-wrap\">",
"                  <span class=\"lp-ico\">\uD83D\uDD11</span>",
"                  <input [type]=\"showPass ? 'text' : 'password'\" class=\"lp-inp lp-trail\"",
...
"      background:#0b1120; position:relative; overflow:hidden; padding:1.5rem; }",
"",
"    /* ── Animated background ── */",
...
"      background:radial-gradient(circle,rgba(29,78,216,0.35) 0%,transparent 70%); animation-duration:10s; }",
"    .lp-o2 { width:400px; height:400px; bottom:-120px; right:-80px;",
"      background:radial-gradient(circle,rgba(109,40,217,0.28) 0%,transparent 70%); animation-duration:12s; animation-delay:2s; }",
"    .lp-o3 { width:280px; height:280px; top:40%; left:40%;",
"      background:radial-gradient(circle,rgba(6,182,212,0.18) 0%,transparent 70%); animation-duration:9s; animation-delay:1s; }",
...
"      background:linear-gradient(145deg,#0d1b3e 0%,#0f2555 40%,#0c1a45 100%);",
...
"      box-shadow:0 6px 20px rgba(59,130,246,0.5); animation:iconBounce 3s ease-in-out infinite; }",
...
"    .lp-hl-grad { background:linear-gradient(90deg,#60a5fa,#a78bfa,#38bdf8);",
...
"    .lp-stat-val { font-size:1.35rem; font-weight:800; color:#60a5fa; }",
...
"    .lp-feat-ico { width:30px; height:30px; background:rgba(59,130,246,0.18);",
...
"    .lp-mb-icon { width:38px; height:38px; background:linear-gradient(135deg,#1d4ed8,#3b82f6);",
...
"    .lp-inp:focus { border-color:#3b82f6; box-shadow:0 0 0 3px rgba(59,130,246,0.12); }",
...
"    .lp-refresh:hover { background:#eff6ff; border-color:#3b82f6; color:#1d4ed8; }",
...
"    .lp-check input:checked ~ .lp-chk { background:#1d4ed8; border-color:#1d4ed8; }",
"    .lp-check input:checked ~ .lp-chk::after { content:'\u2713'; font-size:10px; color:white; font-weight:900; }",
"    .lp-link { font-size:0.84rem; color:#3b82f6; text-decoration:none; font-weight:500; }",
...
"      transition:all 0.3s; box-shadow:0 4px 20px rgba(29,78,216,0.45);",
"      letter-spacing:0.3px; font-family:inherit; }",
"    .lp-submit:not(:disabled):hover { background-position:right center;",
"      box-shadow:0 8px 28px rgba(29,78,216,0.6); transform:translateY(-2px); }",
...
"    .lp-link-bold { color:#1d4ed8; font-weight:700; text-decoration:none; margin-left:0.3rem; }",
...
console.log('login written:', full.length, 'bytes');
