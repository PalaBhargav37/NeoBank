...
@Component({
  ...
  styles: [`
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .landing{min-height:100vh;background:#0A0604;color:#fff;overflow-x:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;}

    /* scroll progress */
    .scroll-bar{position:fixed;top:0;left:0;height:3px;z-index:9999;background:linear-gradient(90deg,#E8411A,#F47920,#F0A500);transition:width .1s linear;box-shadow:0 0 12px rgba(232,65,26,.7);}
    ...
    .o1{width:650px;height:650px;background:#E8411A;top:-200px;left:-180px;animation:orb1 22s ease-in-out infinite;}
    .o2{width:550px;height:550px;background:#F47920;top:15%;right:-160px;animation:orb2 28s ease-in-out infinite;}
    .o3{width:420px;height:420px;background:#F0A500;bottom:18%;left:8%;animation:orb3 19s ease-in-out infinite;}
    .o4{width:340px;height:340px;background:#C84010;bottom:8%;right:18%;animation:orb4 24s ease-in-out infinite;}
    ...
    .navbar.scrolled{background:rgba(10,6,4,.92);backdrop-filter:blur(28px);border-bottom:1px solid rgba(255,255,255,.06);box-shadow:0 8px 50px rgba(0,0,0,.55);}
    ...
    .logo-box{width:46px;height:46px;border-radius:13px;background:linear-gradient(135deg,#E8411A,#F47920);display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden;box-shadow:0 8px 28px rgba(232,65,26,.5);}
    ...
    .nl::after{content:'';position:absolute;bottom:3px;left:50%;right:50%;height:2px;background:linear-gradient(90deg,#E8411A,#F47920);transition:all .3s;border-radius:1px;}
    .nl:hover{color:#fff;}
    ...
    .btn-glow{padding:.55rem 1.35rem;border-radius:11px;color:#fff;background:linear-gradient(135deg,#E8411A,#F47920);text-decoration:none;font-size:.9rem;font-weight:700;box-shadow:0 4px 22px rgba(232,65,26,.48);transition:all .3s;display:flex;align-items:center;gap:.38rem;}
    .btn-glow:hover{transform:translateY(-2px);box-shadow:0 8px 34px rgba(232,65,26,.68);}
    ...
    .mob-menu{padding:1.5rem 2rem;background:rgba(10,6,4,.97);backdrop-filter:blur(20px);border-top:1px solid rgba(255,255,255,.06);animation:slideDown .3s ease;display:flex;flex-direction:column;}
    ...
    .ml-fill{background:linear-gradient(135deg,#E8411A,#F47920);color:#fff;}
    ...
    .hero-pill{display:inline-flex;align-items:center;gap:.55rem;padding:.48rem 1.15rem;border-radius:100px;background:rgba(232,65,26,.1);border:1px solid rgba(232,65,26,.28);font-size:.83rem;color:#FFB585;margin-bottom:1.8rem;animation:fadeUp .6s .3s both;}
    .pill-dot{width:7px;height:7px;border-radius:50%;background:#E8411A;box-shadow:0 0 9px rgba(232,65,26,.9);animation:pdot 2s ease-in-out infinite;}
    @keyframes pdot{0%,100%{transform:scale(1)}50%{transform:scale(1.6);opacity:.6}}
    .pill-star{color:#E8411A;}
    ...
    .grad-text,.typed-word{background:linear-gradient(135deg,#E8411A,#F47920,#F0A500);background-size:200%;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:gradMove 4s ease-in-out infinite;}
    @keyframes gradMove{0%,100%{background-position:0%}50%{background-position:100%}}
    .caret{color:#FFB585;-webkit-text-fill-color:#FFB585;animation:caretBlink .9s step-end infinite;margin-left:2px;}
    ...
    .btn-primary{position:relative;padding:.9rem 2.1rem;border-radius:13px;font-size:1rem;font-weight:700;color:#fff;background:linear-gradient(135deg,#E8411A,#F47920);text-decoration:none;overflow:hidden;box-shadow:0 8px 30px rgba(232,65,26,.45);transition:all .4s;display:inline-flex;align-items:center;gap:.5rem;}
    .btn-primary:hover{transform:translateY(-3px);box-shadow:0 14px 45px rgba(232,65,26,.65);}
    ...
    .play-ico{width:34px;height:34px;border-radius:50%;background:rgba(232,65,26,.18);border:1px solid rgba(232,65,26,.35);display:flex;align-items:center;justify-content:center;font-size:.75rem;transition:all .3s;}
    .btn-outline:hover .play-ico{background:rgba(232,65,26,.28);transform:scale(1.1);}
    ...
    .card-main{top:45px;right:0;width:385px;height:245px;background:linear-gradient(135deg,#C84010,#8B2010);padding:1.8rem;overflow:hidden;animation:cf 6s ease-in-out infinite;}
    ...
    .card-growth{top:0;left:-25px;width:185px;background:rgba(18,10,6,.88);padding:1.2rem;animation:cf2 7s ease-in-out infinite 1.5s;}
    ...
    .card-tx{top:298px;left:-65px;width:288px;background:rgba(14,8,4,.88);padding:1.2rem;display:flex;align-items:center;gap:1rem;animation:cf3 5.5s ease-in-out infinite .5s;}
    ...
    .card-bal{bottom:60px;right:-22px;width:264px;background:linear-gradient(135deg,#160804,#2A1008);padding:1.4rem;animation:cf4 7.5s ease-in-out infinite 2s;}
    ...
    .bal-trend{display:flex;align-items:center;gap:.5rem;font-size:.77rem;color:#F47920;}
    ...
    /* ticker */
    .ticker{position:relative;z-index:1;background:rgba(232,65,26,.07);border-top:1px solid rgba(232,65,26,.18);border-bottom:1px solid rgba(232,65,26,.18);overflow:hidden;padding:.75rem 0;}
    ...
    .t-val{font-size:1rem;font-weight:800;color:#FFB585;}.t-lbl{font-size:.82rem;color:rgba(255,255,255,.42);}.t-sep{color:rgba(232,65,26,.38);font-size:.68rem;}

    /* sections */
    .sect{position:relative;z-index:1;padding:100px 2rem;}.sect-alt{background:rgba(232,65,26,.03);}
    .inner{max-width:1400px;margin:0 auto;}
    .s-head{text-align:center;margin-bottom:4.5rem;}
    .s-badge{display:inline-block;padding:.42rem 1.05rem;border-radius:100px;background:rgba(232,65,26,.1);border:1px solid rgba(232,65,26,.22);font-size:.72rem;font-weight:800;color:#FFB585;letter-spacing:.16em;text-transform:uppercase;margin-bottom:1.2rem;}
    ...
    .feat-card:hover{transform:translateY(-8px);border-color:rgba(232,65,26,.28);box-shadow:0 26px 65px rgba(0,0,0,.48);}
    ...
    .feat-arr{position:absolute;bottom:1.4rem;right:1.7rem;font-size:1.2rem;color:rgba(232,65,26,.28);transition:all .3s;}
    .feat-card:hover .feat-arr{color:#E8411A;transform:translateX(4px);}
    ...
    .hiw-card:hover{transform:translateY(-8px);border-color:rgba(232,65,26,.25);box-shadow:0 22px 55px rgba(0,0,0,.38);}
    .hiw-num{font-size:.72rem;font-weight:900;color:rgba(232,65,26,.52);letter-spacing:.15em;text-transform:uppercase;margin-bottom:1.4rem;}
    .hiw-ring{width:78px;height:78px;border-radius:50%;background:rgba(232,65,26,.1);border:2px solid rgba(232,65,26,.22);display:flex;align-items:center;justify-content:center;margin:0 auto 1.4rem;position:relative;}
    .ring-pulse{position:absolute;inset:-8px;border-radius:50%;border:1px solid rgba(232,65,26,.15);animation:rpulse 2.5s ease-in-out infinite;}
    ...
    .hiw-conn{position:absolute;top:50%;right:-1rem;width:2rem;height:2px;background:linear-gradient(90deg,rgba(232,65,26,.5),transparent);transform:translateY(-50%);}
    ...
    .prod-feat{background:rgba(232,65,26,.06);border-color:rgba(232,65,26,.28);}
    .prod-feat:hover{box-shadow:0 32px 72px rgba(232,65,26,.22);}
    .prod-star{position:absolute;top:-1px;right:1.4rem;background:linear-gradient(135deg,#E8411A,#F47920);padding:.28rem .9rem;border-radius:0 0 10px 10px;font-size:.7rem;font-weight:700;color:#fff;}
    ...
    .prod-btn{display:flex;align-items:center;justify-content:center;padding:.88rem;border-radius:12px;background:rgba(232,65,26,.08);border:1px solid rgba(232,65,26,.22);color:#FFB585;font-weight:700;text-decoration:none;transition:all .3s;font-size:.93rem;}
    .prod-btn:hover{background:rgba(232,65,26,.18);color:#fff;}
    .prod-btn-fill{background:linear-gradient(135deg,#E8411A,#F47920);border:none;color:#fff;box-shadow:0 6px 22px rgba(232,65,26,.38);}
    .prod-btn-fill:hover{box-shadow:0 10px 34px rgba(232,65,26,.58);transform:translateY(-2px);}
    ...
    .testi-card.testi-active{opacity:1;transform:scale(1);border-color:rgba(232,65,26,.25);box-shadow:0 18px 55px rgba(0,0,0,.32);}
    ...
    .tdot.tdot-on{width:28px;background:linear-gradient(90deg,#E8411A,#F47920);}
    ...
    .contact-card:hover{transform:translateY(-8px);border-color:rgba(232,65,26,.25);box-shadow:0 22px 55px rgba(0,0,0,.35);}
    .contact-ring{width:66px;height:66px;border-radius:50%;background:rgba(232,65,26,.08);border:2px solid rgba(232,65,26,.18);display:flex;align-items:center;justify-content:center;font-size:1.75rem;margin:0 auto 1.4rem;}
    ...
    .bank-val{font-size:.98rem;font-weight:700;font-family:monospace;color:#FFB585;}
    ...
    .cta-glow-a{width:700px;height:700px;background:radial-gradient(circle,rgba(232,65,26,.18),transparent 70%);top:50%;left:50%;transform:translate(-50%,-50%);animation:gp 4.5s ease-in-out infinite;}
    .cta-glow-b{width:380px;height:380px;background:radial-gradient(circle,rgba(244,121,32,.13),transparent 70%);top:50%;left:50%;transform:translate(-50%,-50%);animation:gp 4.5s ease-in-out infinite 2.2s;}
    ...
    .cta-badge{display:inline-block;padding:.42rem 1.05rem;border-radius:100px;background:rgba(232,65,26,.12);border:1px solid rgba(232,65,26,.28);font-size:.7rem;font-weight:800;color:#FFB585;letter-spacing:.16em;margin-bottom:1.4rem;}
    ...
    /* footer */
    .footer{position:relative;z-index:1;background:rgba(6,3,2,.98);border-top:1px solid rgba(255,255,255,.055);padding:4rem 2rem 2rem;}
    ...
    .soc:hover{background:rgba(232,65,26,.2);border-color:rgba(232,65,26,.38);color:#FFB585;}
    ...
    .fbot-links a:hover{color:#FFB585;}
...
export class LandingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  avatarColors = ['#E8411A','#F47920','#F0A500','#C84010','#D4600A'];
  ...
  features = [
    { icon:'⚡', title:'Instant Transfers',     desc:'Send money in seconds via UPI, IMPS and NEFT. Available 24/7 with real-time confirmation.',                    tags:['UPI','IMPS','24/7'],           grad:'linear-gradient(135deg,#E8411A,#F47920)', glow:'radial-gradient(circle at 50% 0%,rgba(232,65,26,.32),transparent 68%)' },
    { icon:'📊', title:'Smart Analytics',       desc:'AI-powered spending insights with auto-categorisation, budget goals and trend charts.',                         tags:['AI Insights','Budgets'],       grad:'linear-gradient(135deg,#F47920,#F0A500)', glow:'radial-gradient(circle at 50% 0%,rgba(244,121,32,.32),transparent 68%)' },
    ...
    { icon:'💳', title:'Virtual Cards',         desc:'Instantly generate disposable virtual debit cards for ultra-secure online shopping.',                          tags:['Virtual','Secure'],           grad:'linear-gradient(135deg,#F0A500,#E08C00)', glow:'radial-gradient(circle at 50% 0%,rgba(240,165,0,.32),transparent 68%)' },
  ];
  ...
  products = [
    ...
    { icon:'💎', title:'Premium Account', badge:'Most Popular',  featured:true,  desc:'All-in-one premium banking with rewards, analytics and priority support.',       grad:'linear-gradient(135deg,#E8411A,#F47920)', features:['Unlimited transfers','Rewards on every ₹ spent','Dedicated manager','Airport lounge access'] },
  ...
  private _initParticles() {
    ...
    const draw = () => {
      ...
      for (const p of pts) {
        ...
        ctx.fillStyle = `rgba(232,65,26,${p.op})`; ctx.fill();
      }
      for (let i = 0; i < pts.length; i++) {
        for (let j = i + 1; j < pts.length; j++) {
          ...
          if (d < 125) {
            ...
            ctx.strokeStyle = `rgba(232,65,26,${.13 * (1 - d / 125)})`;
