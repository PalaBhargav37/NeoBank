...
@Component({
          ...
          @if (!editMode()) {
            <div class="drawer-section">
              ...
              <div class="drawer-info-grid">
                ...
                <div class="dig-item"><span class="dig-lbl">Gender</span><span class="dig-val">{{ selectedUser()!.gender || '—' }}</span></div>
                ...
                <div class="dig-item"><span class="dig-lbl">Mobile Number</span><span class="dig-val">{{ selectedUser()!.phone || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">Aadhaar Number</span><span class="dig-val">{{ selectedUser()!.aadhaarNumber ? (selectedUser()!.aadhaarNumber! | slice:0:4) + '-XXXX-' + (selectedUser()!.aadhaarNumber! | slice:8) : '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">PAN Number</span><span class="dig-val">{{ selectedUser()!.panNumber || '—' }}</span></div>
              </div>

              <!-- Address -->
              <div class="info-section-title" style="margin-top:1rem">Address</div>
              <div class="drawer-info-grid">
                <div class="dig-item full"><span class="dig-lbl">Address Line</span><span class="dig-val">{{ selectedUser()!.address || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">City</span><span class="dig-val">{{ selectedUser()!.city || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">District</span><span class="dig-val">{{ selectedUser()!.district || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">State</span><span class="dig-val">{{ selectedUser()!.state || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">Pincode</span><span class="dig-val">{{ selectedUser()!.pincode || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">Country</span><span class="dig-val">{{ selectedUser()!.country || '—' }}</span></div>
              </div>

              <!-- Nominee -->
              <div class="info-section-title" style="margin-top:1rem">Nominee Details</div>
              <div class="drawer-info-grid">
                <div class="dig-item"><span class="dig-lbl">Nominee Name</span><span class="dig-val">{{ selectedUser()!.nomineeName || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">Relation</span><span class="dig-val">{{ selectedUser()!.nomineeRelation || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">Nominee Mobile</span><span class="dig-val">{{ selectedUser()!.nomineeMobile || '—' }}</span></div>
                <div class="dig-item"><span class="dig-lbl">Registered On</span><span class="dig-val">{{ selectedUser()!.createdAt ? (selectedUser()!.createdAt | date:'dd MMM yyyy') : '—' }}</span></div>
              </div>
            </div>
            ...
            <div class="drawer-section">
              ...
              <div class="edit-grid">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" [(ngModel)]="editForm.gender">
                ...
                <div class="form-group">
                  ...
                  @if (editSubmitted && !isPhoneValid(editForm.phone)) { <span class="field-error">Valid 10-digit number required</span> }
                </div>
                <div class="form-group">
                  <label class="form-label">Aadhaar Number</label>
                  <input class="form-control" [(ngModel)]="editForm.aadhaarNumber" placeholder="12-digit Aadhaar number" maxlength="12" />
                  @if (editSubmitted && editForm.aadhaarNumber && !isAadhaarValid(editForm.aadhaarNumber)) {
                    <span class="field-error">Must be 12 digits</span>
                  }
                </div>
                <div class="form-group">
                  <label class="form-label">PAN Number</label>
                  <input class="form-control" [(ngModel)]="editForm.panNumber" placeholder="E.g. ABCDE1234F" maxlength="10" style="text-transform:uppercase" />
                  @if (editSubmitted && editForm.panNumber && !isPanValid(editForm.panNumber)) {
              ...
              <!-- Address -->
              <div class="edit-section-title">Address</div>
              <div class="edit-grid">
                <div class="form-group full">
                  <label class="form-label">Address Line</label>
                  <input class="form-control" [(ngModel)]="editForm.address" placeholder="House/Flat, Street, Area" />
                </div>
                <div class="form-group">
                  <label class="form-label">State</label>
                  <select class="form-control" [(ngModel)]="editForm.state" (ngModelChange)="editForm.district = ''">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" [(ngModel)]="editForm.district" placeholder="District" />
                </div>
                <div class="form-group">
                  <label class="form-label">City</label>
                  <input class="form-control" [(ngModel)]="editForm.city" placeholder="City name" />
                </div>
                <div class="form-group">
                  <label class="form-label">Pincode</label>
                  <input class="form-control" [(ngModel)]="editForm.pincode" placeholder="6-digit pincode" maxlength="6" />
                  @if (editSubmitted && editForm.pincode && !isPincodeValid(editForm.pincode)) {
                    <span class="field-error">Must be 6 digits</span>
                  }
                </div>
                <div class="form-group">
              ...
              <!-- Nominee -->
              <div class="edit-section-title">Nominee Details</div>
              <div class="edit-grid">
                <div class="form-group">
                  <label class="form-label">Nominee Name</label>
                  <input class="form-control" [(ngModel)]="editForm.nomineeName" placeholder="Full name" />
                </div>
                <div class="form-group">
                  <label class="form-label">Relation</label>
                  <select class="form-control" [(ngModel)]="editForm.nomineeRelation">
                ...
                <div class="form-group">
                  <label class="form-label">Nominee Mobile <span style="font-size:0.7rem;color:#94a3b8">(optional)</span></label>
                  <input class="form-control" [(ngModel)]="editForm.nomineeMobile" placeholder="10-digit (optional)" maxlength="10" />
                </div>
              </div>
        ...
        @if (drawerTab() === 'accounts') {
          <div class="drawer-section">
            @if (accountsLoading()) {
              ...
              <div class="drawer-acc-error">
                <div style="font-size:1.5rem;margin-bottom:0.5rem">&#9888;</div>
                <div>{{ accountsError() }}</div>
                <button class="btn btn-secondary" style="margin-top:0.75rem;font-size:0.8rem;padding:0.4rem 1rem"
                  (click)="reloadAccounts()">Retry</button>
              </div>
  ...
  styles: [`
    ...
    .info-section-title{font-size:.72rem;font-weight:800;color:var(--primary);text-transform:uppercase;letter-spacing:.06em;padding:.5rem 0 .35rem;border-bottom:1.5px solid #e2e8f0;margin-bottom:.75rem}
    .edit-section-title{font-size:.72rem;font-weight:800;color:var(--primary);text-transform:uppercase;letter-spacing:.06em;margin:1rem 0 .6rem;padding-bottom:.35rem;border-bottom:1.5px solid #e2e8f0;grid-column:1/-1}
    ...
    .drawer-acc-error{text-align:center;color:#dc2626;font-size:.85rem;padding:1.5rem;background:#fff5f5;border-radius:10px;border:1px solid #fca5a5}
...
export class AdminUsersComponent implements OnInit {
  ...
  openUser(u: User) {
    ...
    this.loadAccounts(u.id);
  }

  loadAccounts(userId: number) {
    this.accountsLoading.set(true);
    this.accountsError.set('');
    this.adminSvc.getUserAccounts(userId).subscribe({
      next: (r) => {
        this.accountsLoading.set(false);
        if (r.success) this.userAccounts.set(r.data);
        else this.accountsError.set('Failed to load accounts.');
      },
      error: (err) => {
        this.accountsLoading.set(false);
        this.accountsError.set(err?.error?.message || 'Could not load accounts. Backend may be unavailable.');
      }
    });
  }

  reloadAccounts() {
    if (this.selectedUser()) this.loadAccounts(this.selectedUser()!.id);
  }
  ...
  startEdit() {
    ...
    this.editForm = {
      ...
      gender: u.gender || '', state: u.state || '', district: u.district || '',
      pincode: u.pincode || '', aadhaarNumber: u.aadhaarNumber || '', panNumber: u.panNumber || '',
      nomineeName: u.nomineeName || '', nomineeRelation: u.nomineeRelation || '', nomineeMobile: u.nomineeMobile || ''
    };
  ...
  isAadhaarValid(v: string | undefined): boolean { return /^\d{12}$/.test(v || ''); }
  isPanValid(v: string | undefined): boolean { return /^[A-Z]{5}[0-9]{4}[A-Z]$/.test((v || '').toUpperCase()); }
  isPincodeValid(v: string | undefined): boolean { return /^\d{6}$/.test(v || ''); }
